...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::patch('/settings/general', [SettingsController::class, 'update'])->middleware('permission:settings.manage')->name('settings.general.update');
    ...
    foreach (['users' => UserController::class, 'roles' => RoleController::class] as $name => $controller) {
        ...
        Route::match(['put', 'patch'], "/$name/{{$parameter}}", [$controller, 'update'])->middleware("permission:$name.update")->name("$name.update");
